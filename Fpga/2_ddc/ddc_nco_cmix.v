...
// Description:    24-bit NCO phase accumulator driving an external sin/cos LUT,
//                 plus the complex (4-multiplier, lower-sideband) mixer that
//                 combines the LUT's cos_lo/sin_lo outputs with the aligned
//                 ADC I/Q samples. This is the frequency-tunable alternative
//                 to the fixed-shift ddc_fs4_mixer.v.
//
// Dependencies:   Instantiated by ddc_frontend_top.v (u_flex_mixer). cos_lo
//                 and sin_lo are supplied externally by a DDS sin/cos LUT IP
//                 core (e.g. dds_lo_lut in fpga_ddc_test_wrapper.v), phased
//                 by this module's phase_out. No sub-module instantiations.
//
//////////////////////////////////////////////////////////////////////////////////

// ============================================================================
// LO sin/cos ports widened from 10-bit to 12-bit to match the upgraded
// Xilinx DDS LO LUT (12-bit output, ~72 dB SFDR vs ~60 dB for the previous
...
//
// Frequency resolution: f_res = Fs / 2^24 = 100 MHz / 16777216 = 5.96 Hz/LSB
// ============================================================================
...
module ddc_nco_cmix (
    ...
    // 24-bit phase accumulator. Free-running modulo-2^24 wraparound;
    // fcw is applied as a plain unsigned add, but because it is stored
    // two's-complement, a "negative" fcw value naturally spins the phase
    // backward, giving a negative-frequency LO (see header note above).
